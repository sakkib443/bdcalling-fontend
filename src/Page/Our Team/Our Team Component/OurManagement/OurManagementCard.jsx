            ...
            <div className="work">
                <div className="border border-gray-300 p-5 rounded-2xl">
                    <div className="flex items-center gap-5">
                        <img className='w-20 h-20 rounded-full' src={management.image} alt="" />
                        <div className="">
                            <h1 className='text-xl font-semibold'>{management.name}</h1>
                            <h4 className='csd'>{management.designation}</h4>
                        </div>
                    </div>
