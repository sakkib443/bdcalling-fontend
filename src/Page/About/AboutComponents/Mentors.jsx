    ...
    <div className="py-16 bg-[#f0fdfa]">
      <div className="w-9/12 mx-auto px-4 flex flex-col lg:flex-row items-center gap-12">
        <div className="lg:w-1/3 text-center lg:text-left space-y-6">
          ...
          <p className="crd text-lg leading-relaxed text-justify">
            Our expert mentors have been contributing to making IT experts for
            the past 16 years. With their utmost dedication, we have been able
            to train more than 90,000 people who are currently working in
            several job sectors. All the mentors have the academic skills and
            job experience in the marketplace. They will be your guide in your
            journey to achieve a bright career.
          </p>
        </div>
