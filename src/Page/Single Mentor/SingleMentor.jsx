            ...
            <div className="mb-8">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  {/* Specialized Areas */}
                  <div className="my-4 ">
                    {/* <h3 className="text-xl font-bold text-gray-800 mb-3 flex items-center outfit-semibold">
                      Specialized Areas
                    </h3> */}
                    <div className="flex flex-wrap gap-2">
                      {mentor.specialized_area?.map((area, idx) => (
                        <span
                          key={idx}
                          className="bg-[#ECFCFB] crd border-gray-200 btn btn-sm text-sm font-medium"
                        >
                          {area}
                        </span>
                      ))}
