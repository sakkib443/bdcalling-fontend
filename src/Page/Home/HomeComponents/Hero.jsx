...
const Hero = () => {
  return (
    <div className="w-full sm:w-11/12 lg:w-10/12 2xl:w-9/12 mx-auto px-4 sm:px-6 lg:px-8 2xl:py-18">
      <div className="flex flex-col lg:flex-row justify-between items-center gap-6 md:gap-8">
        ...
        <div className="flex-1 flex flex-col justify-between w-full">
          <div className="font-poppins">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl 2xl:text-6xl font-semibold outfit">
              <span className="text-4xl sm:text-5xl md:text-6xl 2xl:text-7xl text-[#F79952]">
                Betopia{" "}
              </span>
              Skills Ltd
            </h1>
            ...
            <div className="mb-4">
              <div className="stats shadow w-full flex flex-col sm:flex-row">
                {/* Total Courses */}
                <div className="stat flex items-center gap-1.5 w-full sm:w-auto">
                  <div>
                ...
                <div className="stat flex items-center gap-1.5 w-full sm:w-auto">
                  ...
                  <div>
                    ...
                    <div className="stat-desc text-[#41bfb8] text-xs">
                      31 tasks remaining
                    </div>
                  </div>
                </div>
            ...
            <div className="flex gap-3 sm:gap-4 flex-wrap">
              <button className="flex gap-2 text-base sm:text-lg md:text-xl items-center bg-[#41bfb8] px-3 sm:px-4 py-1 sm:py-2 rounded-md hover:bg-[#38a8a1] transition-colors">
