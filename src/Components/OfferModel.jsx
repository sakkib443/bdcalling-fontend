...
const OfferModal = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div
        className={`relative z-50 bg-white p-8 rounded-2xl shadow-2xl w-[600px] h-[450px] text-center flex flex-col items-center justify-center transform transition-all duration-500 ${visible ? "opacity-100 scale-100" : "opacity-0 scale-90"
          }`}
      >
        {/* Close Icon */}
        <button
